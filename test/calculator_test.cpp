...
protected:
    static constexpr int64_t kCalculatorTimeIntervalInMilliseconds = 60 * 1000;
...
{
    for (int64_t i = 0; i < kCalculatorTimeIntervalInMilliseconds; ++i)
    {
        m_calculator->put(1);
        waitFor(1);
    }

    for (int64_t i = 1 ; i < kCalculatorTimeIntervalInMilliseconds; ++i)
    {
        m_calculator->put(0);
